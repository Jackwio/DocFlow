...
namespace DocFlow.Migrations
{
    ...
    [Migration("20251110121907_AddBackgroundJobEntities")]
    partial class AddBackgroundJobEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocFlow.Documents.Document", b =>
                {
                    ...
                    b.Property<string>("RoutingDestination")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)");
            ...
            modelBuilder.Entity("DocFlow.Quotas.TenantQuota", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppTenantQuotas", (string)null);
                });

            modelBuilder.Entity("DocFlow.Tenants.TenantBillingStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Status", "GracePeriodEndDate");

                    b.ToTable("AppTenantBillingStatuses", (string)null);
                });

            modelBuilder.Entity("DocFlow.Webhooks.WebhookEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
